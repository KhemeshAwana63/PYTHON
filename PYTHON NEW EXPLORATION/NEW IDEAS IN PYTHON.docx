...
THIS IS HOW WE USE THE CONCEPT OF FORMETTED STRING FOR BETTER IN LINE CODE
name = "khemesh"
age = 76
print(f'hello i am {name} and i am {age} year old')


IF YOU WANT A CONNECTED MULTILINE CODE OR CONDITION IN CODE THEN YOU CAN USE \ OR YOU
CAN USE THE BRACKET METHOD
